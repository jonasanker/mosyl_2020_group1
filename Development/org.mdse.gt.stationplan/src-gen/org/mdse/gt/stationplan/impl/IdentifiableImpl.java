 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.gt.stationplan.impl.IdentifiableImpl#getIdentifier <em>Identifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class IdentifiableImpl extends MinimalEObjectImpl.Container implements Identifiable {
	...
	protected EClass eStaticClass() {
		return StationplanPackage.Literals.IDENTIFIABLE;
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StationplanPackage.IDENTIFIABLE__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StationplanPackage.IDENTIFIABLE__IDENTIFIER:
