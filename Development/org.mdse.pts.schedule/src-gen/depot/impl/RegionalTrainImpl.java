 ...
 * </p>
 * <ul>
 *   <li>{@link depot.impl.RegionalTrainImpl#getCoaches <em>Coaches</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RegionalTrainImpl extends TrainImpl implements RegionalTrain {
	...
	public EList<Coach> getCoaches() {
		if (coaches == null) {
			coaches = new EObjectResolvingEList<Coach>(Coach.class, this, DepotPackage.REGIONAL_TRAIN__COACHES);
		}
		return coaches;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DepotPackage.REGIONAL_TRAIN__COACHES:
				return getCoaches();
		}
