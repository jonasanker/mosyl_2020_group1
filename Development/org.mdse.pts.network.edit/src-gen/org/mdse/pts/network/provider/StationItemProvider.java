...
/**
 * This is the item provider adapter for a {@link org.mdse.pts.network.Station} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StationItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addLegsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkPackage.Literals.STATION__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Legs feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addLegsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Station_legs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Station_legs_feature", "_UI_Station_type"),
				 NetworkPackage.Literals.STATION__LEGS,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Station.class)) {
			case NetworkPackage.STATION__NAME:
