...
/**
 * This is the item provider adapter for a {@link org.mdse.pts.network.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NetworkPackage.Literals.NETWORK__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NetworkPackage.Literals.NETWORK__STATIONS);
			childrenFeatures.add(NetworkPackage.Literals.NETWORK__LEGS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Network.class)) {
			case NetworkPackage.NETWORK__NAME:
				...
				return;
			case NetworkPackage.NETWORK__STATIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NetworkPackage.Literals.NETWORK__STATIONS,
				 NetworkFactory.eINSTANCE.createStation()));

		newChildDescriptors.add
			(createChildParameter
				(NetworkPackage.Literals.NETWORK__LEGS,
				 NetworkFactory.eINSTANCE.createLeg()));
	}
