/**
 */
package org.mdse.pts.network.provider;
...
/**
 * This is the item provider adapter for a {@link org.mdse.pts.network.Leg} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LegItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leg_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leg_name_feature", "_UI_Leg_type"),
				 NetworkPackage.Literals.LEG__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDistancePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leg_distance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leg_distance_feature", "_UI_Leg_type"),
				 NetworkPackage.Literals.LEG__DISTANCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStation1PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leg_station1_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leg_station1_feature", "_UI_Leg_type"),
				 NetworkPackage.Literals.LEG__STATION1,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStation2PropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Leg_station2_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Leg_station2_feature", "_UI_Leg_type"),
				 NetworkPackage.Literals.LEG__STATION2,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Leg.class)) {
