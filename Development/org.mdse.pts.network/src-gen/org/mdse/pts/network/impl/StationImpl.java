 ...
 * </p>
 * <ul>
 *   <li>{@link org.mdse.pts.network.impl.StationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.mdse.pts.network.impl.StationImpl#getLegs <em>Legs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StationImpl extends MinimalEObjectImpl.Container implements Station {
	...
	/**
	 * The cached value of the '{@link #getLegs() <em>Legs</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLegs()
	 * @generated
	...
	protected EClass eStaticClass() {
		return NetworkPackage.Literals.STATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NetworkPackage.STATION__NAME, oldName, name));
	}
