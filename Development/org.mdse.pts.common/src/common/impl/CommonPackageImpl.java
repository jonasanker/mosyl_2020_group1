...
import common.util.CommonValidator;
...
public class CommonPackageImpl extends EPackageImpl implements CommonPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTime_Minutes(), ecorePackage.getEInt(), "minutes", null, 1, 1, Time.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTime_Hours(), ecorePackage.getEInt(), "hours", null, 1, 1, Time.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (timeEClass,
		   source,
		   new String[] {
			   "constraints", "max60Minutes max24Hours"
		   });
	}
